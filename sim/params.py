...
BINOMIAL_COEFF_OBSERVE_TO_ASSESS_PER_RECRUITR = 0.1 # OBSERVE to Travel_Site for Assess
...
BINOMIAL_COEFF_RECRUIT_TO_RECRUIT = 0.99 # RECRUIT to RECRUIT
BINOMIAL_COEFF_OBSERVE_TO_EXPLORE = 0.01 # OBSERVE to Explore

# switch from RECRUIT probs
PWR_RECRUIT_TO_TS = 0.5
ADD_RECRUIT_QUAL = 2.0
