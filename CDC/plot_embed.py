...
encoder_dict = torch.load('./CDC/encoder_state_dict3.pth')
...
# np.save('nodes_to_plot.npy', arr)
# np.save('emb.npy', emb)
'''
arr = np.load('nodes_to_plot.npy', allow_pickle=True).item()
