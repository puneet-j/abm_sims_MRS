...
emb = readmatrix('./2DnotAllSuccess_GlobalTrained_AllInfoPlot_emb_trained_on_lots_info.csv');
arr = readmatrix('./2DnotAllSuccess_GlobalTrained_AllInfoPlot_arr_trained_on_lots_info.csv',  OutputType="char");
emb = emb(2:end,:);
