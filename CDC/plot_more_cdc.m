...
% emb = readmatrix('./20I0p5ALLENVS_AGENTS_emb.csv');
% colors_emb = readmatrix('./20I0p5ALLENVS_AGENTS_colors.csv',  OutputType="char");
% poses_node = readmatrix('./20I0p5ALLENVS_AGENTS_poses.csv',  OutputType="char");
% quals_node = readmatrix('./20I0p5ALLENVS_AGENTS_quals.csv');
% global_info_node = readmatrix('./20I0p5ALLENVS_AGENTS_global_info.csv');
% num_agents_node = readmatrix('./20I0p5ALLENVS_AGENTS_num_agents.csv');


emb = readmatrix('./Smaller20I0p5ALLENVS_AGENTS_emb.csv');
colors_emb = readmatrix('./Smaller20I0p5ALLENVS_AGENTS_colors.csv',  OutputType="char");
poses_node = readmatrix('./Smaller20I0p5ALLENVS_AGENTS_poses.csv',  OutputType="char");
quals_node = readmatrix('./Smaller20I0p5ALLENVS_AGENTS_quals.csv');
global_info_node = readmatrix('./Smaller20I0p5ALLENVS_AGENTS_global_info.csv');
num_agents_node = readmatrix('./Smaller20I0p5ALLENVS_AGENTS_num_agents.csv');
