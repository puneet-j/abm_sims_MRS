...
fil2 = open('./RS/final_experiments/alltime.pickle', 'rb')
metatime = pickle.load(fil2)
fil2.close()
fil2 = open('./RS/final_experiments/allsucc.pickle', 'rb')
...
folder_graph = './RS/final_experiments/oneGraphAll_test/'
new = './RS/final_experiments/oneGraphAll_test_/'
