...
# allCols = allCols[:500000]
# colors_plotly = ['blue' if color=='r' else 'green' if color=='b' else 'red' if color=='g' else 'black' for color in allCols]
# colors_plotly = ['red' if color=='r' else 'blue' if color=='b' else 'green' if color=='g' else 'black' for color in allCols]
colors_plotly = allCols
# tsne2 = TSNE(n_components=2)
# d2Trans = tsne2.fit_transform(dat)
